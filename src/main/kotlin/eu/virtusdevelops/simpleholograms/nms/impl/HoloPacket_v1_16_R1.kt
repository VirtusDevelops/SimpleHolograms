...
class HoloPacket_v1_16_R1 : HoloPacket() {
    ...
    override fun getMetaEntityCustomName(name: String): Any {
        val name2 = IChatBaseComponent.ChatSerializer.a(ComponentSerializer.toString(TextComponent.fromLegacyText(name)))
        if(name2 != null) {
        ...
        return DataWatcher.Item<Optional<IChatBaseComponent>>(
            DataWatcherObject(2, DataWatcherRegistry.f), Optional.of(
